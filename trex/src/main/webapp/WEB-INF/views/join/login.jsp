			        ...
			        <div class="content">
				            <div class="signin-cont cont">
					                <form action="/login" method="post" >
						                    <input type="text" name="mem_id" id="mem_id" class="inpt" required="required" placeholder="Your id"/>
...
//아이디 검사 ---------------------------------------------------------------------------
   ...
   function Login()
   {
           var form = document.form1;
                  ...
                  {
                          alert("아이디를 입력해야 합니다!");
                          form.mem_id.focus();//포커스를 id박스로 이동.
                          return;
                  }

                  //아이디 입력 문자수를 4~12자로 제한하는 조건문

                  if (form.mem_id.value.length < 4 || form.mem_id.value.length > 12)
                  {
                   alert("아이디는 4~12자 이내로 입력 가능합니다!");

                   form.mem_id.select();//입력한 문자를 선택 상태로 만듬.
                   return;
                  }
