      ...
      <div class="naviwrap">
         ...
         <div class="nv_service">
            <a class="nvs_print" href="#total"
               onclick="printContent();return false"><span
         ...
         <div id="txt">
            ...
            <form name="inputFrm" method="post"
               ...
               <div class="board_butt">
                  <input type="image"
                     src="<%=request.getContextPath() %>/resources/imagesentry.gif" alt="등록">
                  <a
                     href="./list"><img
                     src="<%=request.getContextPath() %>/resources/imagescancel.gif" alt="취소"></a>
                  <a
                     href="./list"><img
                     src="<%=request.getContextPath() %>/resources/imageslist.gif" alt="목록"></a>
               </div>
            </form>
            <!--  웹필터 수정 -->
            <!--  웹필터 수정 -->
