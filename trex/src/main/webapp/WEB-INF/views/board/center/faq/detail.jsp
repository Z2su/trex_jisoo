		...
		<div id="content">
			...
			<div id="txt">
				...
				<div class="board_viewTit">
					<h4>
						<span>제 목</span>${faqboard.title }
					</h4>
				</div>
				<ul class="board_viewInfo">

					<li class="writer"><span>작성자</span>${faqboard.writer }</li>

					<li class="date"><span>작성일</span>
					<fmt:formatDate pattern="yyyy-MM-dd HH:mm"
							value="${faqboard.regdate}" /></li>

					<li class="visit"><span>조회수</span>${faqboard.viewcnt }</li>
