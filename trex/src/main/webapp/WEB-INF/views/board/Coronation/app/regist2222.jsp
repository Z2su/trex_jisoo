			...
			<div id="txt">
				...
				<form name="inputFrm" method="post" action="regist">
					<ul class="board_writeInfo">
						...
						<li><label for="perform">공연정보</label> <input type="text"
							id="perform" name="wrtPF" value=""></li>
							
						<li><label for="pfsh">일정정보</label> <input type="text"
							id="pfsh" name="wrtPFSH" value=""></li>	
