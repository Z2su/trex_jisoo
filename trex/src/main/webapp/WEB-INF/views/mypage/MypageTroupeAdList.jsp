	...
	<div id="contentswrap">
		...
		<div id="navigation">
			<div class="naviwrap">
				...
				<navi> <a
					href="<%=request.getContextPath()%>/mypage/MypageTroupeCrAppList">광고신청조회</a>
				</navi>
					...
					<div class="board_listBox">
						<div class="board_list">
							<form method="post" name="chkForm"
								...
								<table
									summary="광고신청조회입니다. 총 4224개의 글이 있으며 제목링크를 통해서 상세내용으로 이동합니다.">
									<caption>광고신청조회</caption>
									<thead>
									...
									<tbody>
										<tr>
											...
											<td class="title"><img
												...
												alt="잠긴글"><a
												href="./?code=customer&amp;mode=V&amp;no=ziASixn1hjTZHMWDAuWheg&amp;code=customer&amp;site_dvs_cd=kr&amp;menu_dvs_cd=040202&amp;skey=&amp;sval=&amp;GotoPage=">광고신청 합니다.</a>&nbsp;</td>

											<td class="center">류 * * &nbsp;</td>
											<td class="center">KBO&nbsp;</td>
											<td class="center">광고신청&nbsp;</td>
