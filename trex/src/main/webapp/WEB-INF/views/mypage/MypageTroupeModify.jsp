...
<div id="contentswrap">
	...
	<div id="navigation">
		<div class="naviwrap">
			...
			<navi> <a
				href="<%=request.getContextPath()%>/mypage/MypageTroupeList ">마이페이지</a>&gt;
			<a href="<%=request.getContextPath()%>/mypage/MypageTroupeModify ">공연단정보수정</a>
			</navi>
